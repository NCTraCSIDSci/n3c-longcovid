CREATE TABLE `/UNITE/LDS/harmonized/microvisits_to_macrovisits` TBLPROPERTIES (foundry_transform_profiles = 'EXECUTOR_MEMORY_MEDIUM, NUM_EXECUTORS_8') AS
...
(
    ...
    FROM `/UNITE/LDS/macrovisits/initial_macrovisits_with_microvisits`
...
(
    SELECT m.* 
    FROM `/UNITE/LDS/macrovisits/initial_macrovisits_with_microvisits` m
