...
Feature_Table_Builder feat JOIN
	(SELECT 
	nvl(pre_person_id, post_person_id) as person_id, nvl(pre_patient_group, post_patient_group) as patient_group, 
	nvl(pre_condition_concept_name, post_condition_concept_name) as condition_concept_name, 
	nvl(pre_condition_concept_id, post_condition_concept_id) as condition_concept_id, nvl(pre_dx_count, 0) as 
	pre_dx_count, nvl(post_dx_count, 0) as post_dx_count
